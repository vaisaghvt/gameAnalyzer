 ...
 */
public class RoomAnalysisHandler extends StatisticsHandler<RoomInfoConsoleDisplay, RoomInfoChartDisplay> {


    public RoomAnalysisHandler() {
        super(new RoomInfoChartDisplay(),
                new RoomInfoConsoleDisplay()
        );
...
//                    Multiset<Double> data = summarizeData(dataNameDataMap, phase);
                    ...
                    chartDisplay.setTitle(dataName + ": Room data display");
...
//                Multiset<Double> data = summarizeData(dataNameDataMap, phase);
                ...
                chartDisplay.setTitle("Room data display");
