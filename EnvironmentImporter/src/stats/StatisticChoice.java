...
public enum StatisticChoice {
    ...
    DOOR_USE_FREQUENCY("DoorUseFrequencyStatisticHandler", "Frequency of use of each door"
            , true, true,true,  Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    TIME_SPENT_PER_VERTEX("VertexVisitDurationStatisticHandler", "Time spent in each room", true, true, false,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    VERTEX_VISIT_TIMES("", "Time at which each vertex was visited - Only for internal use", false, false,false,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    PATH_FREQUENCY("PathStatisticHandler", "Frequency of each path", false, false,false,
    ...
    CORRIDOR_PREFERENCE_MEASURE("CorridorPrefStatisticHandler", "Frequency of exploring through a non corridor", false, false, false,
            Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    DOOR_REPETITION_FREQUENCY("DoorRepetitionFrequencyStatisticHandler", "Frequency of deltaT = time diff b/w door usages", true, true,false,
            Phase.EXPLORATION, Phase.TASK_1),
    NODE_REPETITION_FREQUENCY("NodeRepetitionFrequencyStatisticHandler", "Frequency of deltaT = time diff b/w room visits", true, true,false,
            Phase.EXPLORATION, Phase.TASK_1),
    COVERAGE("CoverageStatisticHandler", "Frequency of overall coverage", false, false,false,
            Phase.EXPLORATION),
    VERTEX_VISIT_HISTOGRAM("VertexVisitCountStatisticHandler", "Frequency of normalized visit times", true, false,false,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    ROOM_DURATION_FREQUENCY("RoomDurationTotalFrequencyStatisticHandler", "Frequency of time spent per room", true, false,false,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    DISTANCE_TIME_EXPLORATION_STATISTIC("DistanceTimeExplorationStatisticHandler", "Distance and time taken by each agent - Exploration", false, false, false),
    DISTANCE_TIME_FOR_TASKS_STATISTIC("DistanceTimeForTasksStatisticHandler", "Distance and time taken by each agent - Tasks", false, false, false),
   ...
   SECOND_ORDER_HEAT_MAP("SecondOrderPathHeatMapHandler", "Plot a heat map of second order markov probabilities from rooms", true, false,true,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),
    FIRST_ORDER_HEAT_MAP("FirstOrderPathHeatMapHandler", "Plot a heat map of first order markov probabilities from rooms", true, false,true,
            Phase.EXPLORATION, Phase.TASK_1, Phase.TASK_2, Phase.TASK_3),;
    ...
    StatisticChoice(String handler, String description, boolean canAggregate, boolean hasAggregationChoice, boolean randomWalkPossible, Phase... phases) {
